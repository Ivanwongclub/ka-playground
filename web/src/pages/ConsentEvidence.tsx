  ...
  return (
    <Space direction="vertical" size="large" style={{ width: '100%' }}>
      ...
      <DataBoundary loading={loading} error={error}>
        ...
        <Card title={t('consent.evidence.coverage')} style={{ marginTop: 16 }}>
          <Table<Coverage>
        ...
        <Card title={t('consent.evidence.download')} style={{ marginTop: 16 }}>
          <Table<SignatureRow>
            rowKey="id"
            size="small"
        ...
        <Space wrap style={{ width: '100%', alignItems: 'stretch', marginTop: 16 }}>
        ...
        <Statistic title={t('consent.evidence.signatures')} value={signatures.length} style={{ marginTop: 16 }} />
      </DataBoundary>
    </Space>
  );
}
