# SPRINT KAP-S04A — Enrolment as intent, consent gating & the awaiting-a-team pool

> PROMOTED 2026-07-27 on Leo's review acceptance — replaces the individual-seat card. Team-based
> capacity per OD-31/32/34/43 and the boundary table (PROPOSED-BOUNDARY-S04A-S04B-S05.md).
...
- No client-question dependency: the fee-terms question is CLOSED (OD-67 — uniform programme fee).
