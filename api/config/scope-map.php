...
return [
    ...
    'global' => [
        ...
        'budget_categories' => 'Readable by EVERY authenticated session: the fixed seeded team-budget category set (S07 D-B1); trilingual reference data, no personal or commercial data; system-seeded, not user-writable.',
